...
g.prototype);j.constructor=g;j[k+"_super"]=e;e=j}g.prototype=e;h(g,d)}var f=b("org.startpad.types");a.extend({VERSION:"0.3.0",methods:h,bind:g,decorate:k,create:Object.create||q,subclass:m,mro:r,numericVersion:d,monkeyPatch:e,patch:function(){e(Function,"org.startpad.funcs",a.VERSION,{methods:function(a){h(this,a)},curry:function(){var a=[this,void 0].concat(f.copyArray(arguments));return g.apply(void 0,a)},curryThis:function(a){var b=f.copyArray(arguments);b.unshift(this);return g.apply(void 0,b)},
...
handleLocationHash().doc||$.ajax({url:"slides.html",error:function(){console.log("ajax load error")},success:function(a){renderedText=latestText=doc.editor.value=a;$(doc.output).html("<section class='slides'>"+a+"</section>");handleDomLoaded();getSlideBoundries();setCursorPos();onResize();$(doc.output).css("display","block")}});for(var a=$("script[type=slide-template]"),b,d=0;d<a.length;d++)b=a[d],stockCode[b.title]=$(b).text()}
...
function setDoc(a){console.log("setDoc()");a.blob.version===1?latestText=a.blob.markdown:a.blob.version===1.1?latestText=a.blob.slides:console.log("ERROR: unknown blob version number");index?($("body").html("<section class='slides'>"+latestText+"</section>"),handleDomLoaded()):(renderedText=doc.editor.value=latestText,$(doc.output).html("<section class='slides'>"+latestText+"</section>"),handleDomLoaded(),getSlideBoundries(),setCursorPos(),onResize(),$(doc.output).css("display","block"),updateMeta(a))}
function getDoc(){return index?{blob:void 0,reader:["public"]}:{blob:{version:1.1,slides:doc.editor.value},readers:["public"]}}function handleAppCache(){typeof applicationCache!="undefined"&&(applicationCache.status==applicationCache.UPDATEREADY?(applicationCache.swapCache(),location.reload()):applicationCache.addEventListener("updateready",handleAppCache,!1))};