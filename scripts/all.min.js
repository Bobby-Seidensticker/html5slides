(function(a){function b(){}function d(a){if(!a)return 0;a=a.split(".");return 1E4*parseInt(a[0])+100*parseInt(a[1])+parseInt(a[2])}function e(a){for(var a=a.replace(/-/g,"_"),a=a.split("."),d=h,e=0;e<a.length;e++)d[a[e]]===void 0&&(d[a[e]]=new b),d=d[a[e]];return d}var h=a.namespace;if(h){if(d("3.0.1")<=d(h.VERSION))return;b=h.constructor}else a.namespace=h=new b;h.VERSION="3.0.1";a=b.prototype;a.module=function(a,b){var d=e(a);b&&b(d,e);return d};a.extend=function(a){for(var b in a)a.hasOwnProperty(b)&&
(this[b]=a[b])}})(this);
...
void 0&&(a={});for(b=1;b<arguments.length;b++){e=arguments[b];for(f in e)e.hasOwnProperty(f)&&(a[f]=e[f]);if(h)for(d=0;d<g.length;d++)f=g[d],e.hasOwnProperty(f)&&(a[f]=e[f])}return a},project:function(a,b){for(var d={},e=0;e<b.length;e++){var f=b[e];a&&a.hasOwnProperty(f)&&(d[f]=a[f])}return d},getFunctionName:function(a){if(typeof a=="function"){a=a.toString().match(/function\s*(\S+)\s*\(/);if(!a)return"";return a[1]}}});var e=["number","string","boolean","array","function","date","regexp","arguments",
"undefined","null"],h=!{toString:!0}.propertyIsEnumerable("toString"),g=["toString","toLocaleString","valueOf","constructor","isPrototypeOf"]});
namespace.module("org.startpad.funcs",function(a,b){function d(a){if(!a)return 0;a=a.split(".");return 1E4*parseInt(a[0])+100*parseInt(a[1])+parseInt(a[2])}function e(a,b,e,f){if(!(a._patches&&d(a._patches[b])>=d(e)))a._patches=a._patches||{},a._patches[b]=e,h(a,f)}function h(a,b){f.extend(a.prototype,b)}function g(a,b){function d(a,b){for(var e=f.copyArray(a),b=f.copyArray(b),n=0;n<e.length;n++)e[n]===void 0&&(e[n]=b.shift());return e.concat(b)}var e;e=arguments.length==3&&f.isArguments(arguments[2])?
Array.prototype.slice.call(arguments[2],self1):Array.prototype.slice.call(arguments,2);return function(){return a.apply(b||this,d(e,arguments))}}function k(a,b){function d(){return b.call(this,a,arguments,d)}b.call(a,void 0,arguments,d);return d}function q(a){function b(){}b.prototype=a;return new b}function m(b,d,e){b.prototype=a.create(d.prototype);b.prototype.constructor=b;h(b,e)}function r(b,d){for(var e=b.pop().prototype,g;b.length>0;){g=b.pop();var k=f.getFunctionName(g),j=a.create(e);f.extend(j,
g.prototype);j.constructor=g;j[k+"_super"]=e;e=j}g.prototype=e;h(g,d)}var f=b("org.startpad.types");a.extend({VERSION:"0.3.0",methods:h,bind:g,decorate:k,create:Object.create||q,subclass:m,mro:r,numericVersion:d,monkeyPatch:e,patch:function(){e(Function,"org.startpad.funcs",a.VERSION,{methods:function(a){h(this,a)},curry:function(){var a=[this,void 0].concat(f.copyArray(arguments));return g.apply(void 0,a)},curryThis:function(){var a=f.copyArray(arguments);a.unshift(this);return g.apply(void 0,a)},
decorate:function(a){return k(this,a)},subclass:function(a,b){m(this,a,b)},mro:function(a,b){a.unshift(this);r(a,b)}});return a}})});
namespace.module("org.startpad.string",function(a,b){function d(a,b,d){d=d||h;if(a==void 0)return"undefined";a=a.toString();return a=a.replace(d,function(a,d){for(var e=b,h=d.split("."),g=0;g<h.length;g++){var d=h[g],o=parseInt(d),e=isNaN(o)?e[d]:e[o];if(e==void 0)return""}return e})}var e=b("org.startpad.funcs");a.extend({VERSION:"0.1.2",patch:function(){e.monkeyPatch(String,"org.startpad.string",a.VERSION,{format:function(){return arguments.length==1&&typeof arguments[0]=="object"?d(this,arguments[0]):
d(this,arguments)}});return a},format:d});var h=/\{\s*([^} ]+)\s*\}/g});var Showdown={converter:function(){var a,b,d,e=0;this.makeHtml=function(c){a=[];b=[];d=[];c=c.replace(/~/g,"~T");c=c.replace(/\$/g,"~D");c=c.replace(/\r\n/g,"\n");c=c.replace(/\r/g,"\n");c=w("\n\n"+c+"\n\n");c=c.replace(/^[ \t]+$/mg,"");c=g(c);c=h(c);c=q(c);c=x(c);c=c.replace(/~D/g,"$$");return c=c.replace(/~T/g,"~")};var h=function(c){return c=c.replace(/^[ ]{0,3}\[(.+)\]:[ \t]*\n?[ \t]*<?(\S+?)>?[ \t]*\n?[ \t]*(?:(\n*)["(](.+?)[")][ \t]*)?(?:\n+|\Z)/gm,function(c,d,e,i,f){d=d.toLowerCase();a[d]=
y(e);if(i)return i+f;else f&&(b[d]=f.replace(/"/g,"&quot;"));return""})},g=function(c){c=c.replace(/\n/g,"\n\n");c=c.replace(/^(<(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del)\b[^\r]*?\n<\/\2>[ \t]*(?=\n+))/gm,k);c=c.replace(/^(<(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math)\b[^\r]*?.*<\/\2>[ \t]*(?=\n+)\n)/gm,k);c=c.replace(/(\n[ ]{0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,k);c=c.replace(/(\n\n[ ]{0,3}<!(--[^\r]*?--\s*)+>[ \t]*(?=\n{2,}))/g,
k);c=c.replace(/(?:\n\n)([ ]{0,3}(?:<([?%])[^\r]*?\2>)[ \t]*(?=\n{2,}))/g,k);return c=c.replace(/\n\n/g,"\n")},k=function(c,a){var b;b=a.replace(/\n\n/g,"\n");b=b.replace(/^\n/,"");b=b.replace(/\n+$/g,"");return b="\n\n~K"+(d.push(b)-1)+"K\n\n"},q=function(c){for(var c=z(c),a=j("<hr />"),c=c.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm,a),c=c.replace(/^[ ]{0,2}([ ]?\-[ ]?){3,}[ \t]*$/gm,a),c=c.replace(/^[ ]{0,2}([ ]?\_[ ]?){3,}[ \t]*$/gm,a),c=u(c),c=A(c),c=C(c),c=g(c),c=c.replace(/^\n+/g,""),c=c.replace(/\n+$/g,
""),b=c.split(/\n{2,}/g),c=[],a=b.length,e=0;e<a;e++){var i=b[e];i.search(/~K(\d+)K/g)>=0?c.push(i):i.search(/\S/)>=0&&(i=m(i),i=i.replace(/^([ \t]*)/g,"<p>"),i+="</p>",c.push(i))}a=c.length;for(e=0;e<a;e++)for(;c[e].search(/~K(\d+)K/)>=0;)b=d[RegExp.$1],b=b.replace(/\$/g,"$$$$"),c[e]=c[e].replace(/~K\d+K/,b);return c=c.join("\n\n")},m=function(a){a=B(a);a=r(a);a=a.replace(/\\(\\)/g,s);a=a.replace(/\\([`*_{}\[\]()>#+-.!])/g,s);a=a.replace(/(!\[(.*?)\][ ]?(?:\n[ ]*)?\[(.*?)\])()()()()/g,n);a=a.replace(/(!\[(.*?)\]\s?\([ \t]*()<?(\S+?)>?[ \t]*((['"])(.*?)\6[ \t]*)?\))/g,
...
return c});a=a.replace(/~A/g,"    ");return a=a.replace(/~B/g,"")},p=function(a,b,d){b="(["+b.replace(/([\[\]\\])/g,"\\$1")+"])";d&&(b="\\\\"+b);return a=a.replace(RegExp(b,"g"),s)},s=function(a,b){return"~E"+b.charCodeAt(0)+"E"}}};var clientLib=require("com.pageforest.client"),dom=require("org.startpad.dom"),format=require("org.startpad.format"),markdown=new Showdown.converter;exports.extend({onReady:onReady,onReadyIndex:onReadyIndex,getDoc:getDoc,setDoc:setDoc,onSaveSuccess:onSaveSuccess,handleLocationHash:handleLocationHash,setCursorPos:setCursorPos,getDocid:getDocid,setDocid:setDocid});
...
function setCrossTransform(a,b){var d="translate("+currentShift+"px, "+currentScroll+"px) scale("+currentScale+")";$(a).css("-webkit-"+b,d);$(a).css("-moz-"+b,d);$(a).css("-o-"+b,d);$(a).css("-ms-"+b,d);$(a).css(b,d)}function updateMeta(a){document.title=a.title;$("#title").text(a.title);$(doc.fullscreen).unbind();$(doc.fullscreen).attr("href",location.href.replace("editor","").replace(/&page=[0-9]+/,""))}
