(function(b){function c(){}function d(b){if(!b)return 0;b=b.split(".");return 1E4*parseInt(b[0])+100*parseInt(b[1])+parseInt(b[2])}function e(b){for(var b=b.replace(/-/g,"_"),b=b.split("."),g=h,d=0;d<b.length;d++)g[b[d]]===void 0&&(g[b[d]]=new c),g=g[b[d]];return g}var h=b.namespace;if(h){if(d("3.0.1")<=d(h.VERSION))return;c=h.constructor}else b.namespace=h=new c;h.VERSION="3.0.1";b=c.prototype;b.module=function(b,c){var d=e(b);c&&c(d,e);return d};b.extend=function(b){for(var c in b)b.hasOwnProperty(c)&&
(this[c]=b[c])}})(this);
...
g.prototype);k.constructor=g;k[j+"_super"]=e;e=k}g.prototype=e;h(g,d)}var f=c("org.startpad.types");b.extend({VERSION:"0.3.0",methods:h,bind:j,decorate:g,create:Object.create||q,subclass:m,mro:r,numericVersion:d,monkeyPatch:e,patch:function(){e(Function,"org.startpad.funcs",b.VERSION,{methods:function(b){h(this,b)},curry:function(){var b=[this,void 0].concat(f.copyArray(arguments));return j.apply(void 0,b)},curryThis:function(){var b=f.copyArray(arguments);b.unshift(this);return j.apply(void 0,b)},
decorate:function(b){return g(this,b)},subclass:function(b,c){m(this,b,c)},mro:function(b,c){b.unshift(this);r(b,c)}});return b}})});
namespace.module("org.startpad.string",function(b,c){function d(b,c,d){d=d||h;if(b==void 0)return"undefined";b=b.toString();return b=b.replace(d,function(b,d){for(var e=c,h=d.split("."),j=0;j<h.length;j++){var d=h[j],o=parseInt(d),e=isNaN(o)?e[d]:e[o];if(e==void 0)return""}return e})}var e=c("org.startpad.funcs");b.extend({VERSION:"0.1.2",patch:function(){e.monkeyPatch(String,"org.startpad.string",b.VERSION,{format:function(){return arguments.length==1&&typeof arguments[0]=="object"?d(this,arguments[0]):
...
function(a){a=a.replace(/(.)<\/?code>(?=.)/g,"$1`");return a=p(a,"\\`*_")})},f=function(a,d,e,l,i,f,h,g){g==void 0&&(g="");a=l.toLowerCase();if(i=="")if(a==""&&(a=e.toLowerCase().replace(/ ?\n/g," ")),b[a]!=void 0)i=b[a],c[a]!=void 0&&(g=c[a]);else if(d.search(/\(\s*\)$/m)>-1)i="";else return d;i=p(i,"*_");d='<a href="'+i+'"';g!=""&&(g=g.replace(/"/g,"&quot;"),g=p(g,"*_"),d+=' title="'+g+'"');d+=">"+e+"</a>";return d},n=function(a,d,e,l,i,f,g,h){a=e;l=l.toLowerCase();h||(h="");if(i=="")if(l==""&&
...
function onEditChange(){editTimer&&clearTimeout(editTimer);var b=doc.editor.value;b!=lastText&&(client.setDirty(),lastText=b,editTimer=setTimeout(render,EDIT_BUFFER))}function render(){editTimer&&clearTimeout(editTimer);$(doc.output).html("<section class='slides'>"+lastText+"</section>");refresh();tooFarInFuture();onResize()}function tooFarInFuture(){if(!(curSlide<slideEls.length))for(var b=curSlide+1-slideEls.length,c=0;c<b;c++)prevSlide()}
function toggleEditor(){(editVisible=!editVisible)?($(doc.page).addClass("edit"),editorInitialized||(editorInitialized=!0,$(doc.editor).bind("keyup",onEditChange))):(render(),$(doc.page).removeClass("edit"),currentScroll=0);onResize();$(doc.edit).val(editVisible?"hide":"edit")}function insertStockCode(){var b=stockCode[$(doc.select).val()];if(b){var c=$(doc.editor).val(),b=c.slice(0,doc.editor.selectionStart)+trimCode(b)+c.slice(doc.editor.selectionEnd);$(doc.editor).val(b);onEditChange()}}
...
function onReady(){handleAppCache();doc=dom.bindIDs();client=new clientLib.Client(exports);client.saveInterval=0;client.addAppBar();$(doc.edit).click(toggleEditor);$(doc.insert).click(insertStockCode);$(window).bind("scroll",onScroll);for(var b=$("script[type=slide-template]"),c,d=0;d<b.length;d++)c=b[d],stockCode[c.title]=$(c).text();$.ajax({url:"slides.html",error:function(){console.log("ajax load error")},success:function(b){lastText=b;doc.editor.value=b;b=document.createElement("script");b.type=
