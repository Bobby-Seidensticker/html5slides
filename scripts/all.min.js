(function(b){function c(){}function d(b){if(!b)return 0;b=b.split(".");return 1E4*parseInt(b[0])+100*parseInt(b[1])+parseInt(b[2])}function e(b){for(var b=b.replace(/-/g,"_"),b=b.split("."),d=h,j=0;j<b.length;j++)d[b[j]]===void 0&&(d[b[j]]=new c),d=d[b[j]];return d}var h=b.namespace;if(h){if(d("3.0.1")<=d(h.VERSION))return;c=h.constructor}else b.namespace=h=new c;h.VERSION="3.0.1";b=c.prototype;b.module=function(b,c){var d=e(b);c&&c(d,e);return d};b.extend=function(b){for(var c in b)b.hasOwnProperty(c)&&
(this[c]=b[c])}})(this);
...
void 0&&(b={});for(c=1;c<arguments.length;c++){e=arguments[c];for(f in e)e.hasOwnProperty(f)&&(b[f]=e[f]);if(h)for(d=0;d<g.length;d++)f=g[d],e.hasOwnProperty(f)&&(b[f]=e[f])}return b},project:function(b,c){for(var d={},e=0;e<c.length;e++){var f=c[e];b&&b.hasOwnProperty(f)&&(d[f]=b[f])}return d},getFunctionName:function(b){if(typeof b=="function"){b=b.toString().match(/function\s*(\S+)\s*\(/);if(!b)return"";return b[1]}}});var e=["number","string","boolean","array","function","date","regexp","arguments",
"undefined","null"],h=!{toString:!0}.propertyIsEnumerable("toString"),g=["toString","toLocaleString","valueOf","constructor","isPrototypeOf"]});
namespace.module("org.startpad.funcs",function(b,c){function d(b){if(!b)return 0;b=b.split(".");return 1E4*parseInt(b[0])+100*parseInt(b[1])+parseInt(b[2])}function e(b,c,e,f){if(!(b._patches&&d(b._patches[c])>=d(e)))b._patches=b._patches||{},b._patches[c]=e,h(b,f)}function h(b,c){f.extend(b.prototype,c)}function g(b,c){function d(b,c){for(var e=f.copyArray(b),c=f.copyArray(c),o=0;o<e.length;o++)e[o]===void 0&&(e[o]=c.shift());return e.concat(c)}var e;e=arguments.length==3&&f.isArguments(arguments[2])?
Array.prototype.slice.call(arguments[2],self1):Array.prototype.slice.call(arguments,2);return function(){return b.apply(c||this,d(e,arguments))}}function m(b,c){function d(){return c.call(this,b,arguments,d)}c.call(b,void 0,arguments,d);return d}function j(b){function c(){}c.prototype=b;return new c}function n(c,d,e){c.prototype=b.create(d.prototype);c.prototype.constructor=c;h(c,e)}function q(c,d){for(var e=c.pop().prototype,g;c.length>0;){g=c.pop();var j=f.getFunctionName(g),k=b.create(e);f.extend(k,
g.prototype);k.constructor=g;k[j+"_super"]=e;e=k}g.prototype=e;h(g,d)}var f=c("org.startpad.types");b.extend({VERSION:"0.3.0",methods:h,bind:g,decorate:m,create:Object.create||j,subclass:n,mro:q,numericVersion:d,monkeyPatch:e,patch:function(){e(Function,"org.startpad.funcs",b.VERSION,{methods:function(b){h(this,b)},curry:function(){var b=[this,void 0].concat(f.copyArray(arguments));return g.apply(void 0,b)},curryThis:function(){var b=f.copyArray(arguments);b.unshift(this);return g.apply(void 0,b)},
decorate:function(b){return m(this,b)},subclass:function(b,c){n(this,b,c)},mro:function(b,c){b.unshift(this);q(b,c)}});return b}})});
namespace.module("org.startpad.string",function(b,c){function d(b,c,d){d=d||h;if(b==void 0)return"undefined";b=b.toString();return b=b.replace(d,function(b,d){for(var e=c,h=d.split("."),g=0;g<h.length;g++){var d=h[g],j=parseInt(d),e=isNaN(j)?e[d]:e[j];if(e==void 0)return""}return e})}var e=c("org.startpad.funcs");b.extend({VERSION:"0.1.2",patch:function(){e.monkeyPatch(String,"org.startpad.string",b.VERSION,{format:function(){return arguments.length==1&&typeof arguments[0]=="object"?d(this,arguments[0]):
d(this,arguments)}});return b},format:d});var h=/\{\s*([^} ]+)\s*\}/g});var Showdown={converter:function(){var b,c,d,e=0;this.makeHtml=function(a){b=[];c=[];d=[];a=a.replace(/~/g,"~T");a=a.replace(/\$/g,"~D");a=a.replace(/\r\n/g,"\n");a=a.replace(/\r/g,"\n");a=w("\n\n"+a+"\n\n");a=a.replace(/^[ \t]+$/mg,"");a=g(a);a=h(a);a=j(a);a=x(a);a=a.replace(/~D/g,"$$");return a=a.replace(/~T/g,"~")};var h=function(a){return a=a.replace(/^[ ]{0,3}\[(.+)\]:[ \t]*\n?[ \t]*<?(\S+?)>?[ \t]*\n?[ \t]*(?:(\n*)["(](.+?)[")][ \t]*)?(?:\n+|\Z)/gm,function(a,d,e,i,f){d=d.toLowerCase();b[d]=
y(e);if(i)return i+f;else f&&(c[d]=f.replace(/"/g,"&quot;"));return""})},g=function(a){a=a.replace(/\n/g,"\n\n");a=a.replace(/^(<(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del)\b[^\r]*?\n<\/\2>[ \t]*(?=\n+))/gm,m);a=a.replace(/^(<(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math)\b[^\r]*?.*<\/\2>[ \t]*(?=\n+)\n)/gm,m);a=a.replace(/(\n[ ]{0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,m);a=a.replace(/(\n\n[ ]{0,3}<!(--[^\r]*?--\s*)+>[ \t]*(?=\n{2,}))/g,
m);a=a.replace(/(?:\n\n)([ ]{0,3}(?:<([?%])[^\r]*?\2>)[ \t]*(?=\n{2,}))/g,m);return a=a.replace(/\n\n/g,"\n")},m=function(a,b){var c;c=b.replace(/\n\n/g,"\n");c=c.replace(/^\n/,"");c=c.replace(/\n+$/g,"");return c="\n\n~K"+(d.push(c)-1)+"K\n\n"},j=function(a){for(var a=z(a),b=k("<hr />"),a=a.replace(/^[ ]{0,2}([ ]?\*[ ]?){3,}[ \t]*$/gm,b),a=a.replace(/^[ ]{0,2}([ ]?\-[ ]?){3,}[ \t]*$/gm,b),a=a.replace(/^[ ]{0,2}([ ]?\_[ ]?){3,}[ \t]*$/gm,b),a=u(a),a=A(a),a=C(a),a=g(a),a=a.replace(/^\n+/g,""),a=a.replace(/\n+$/g,
""),c=a.split(/\n{2,}/g),a=[],b=c.length,e=0;e<b;e++){var i=c[e];i.search(/~K(\d+)K/g)>=0?a.push(i):i.search(/\S/)>=0&&(i=n(i),i=i.replace(/^([ \t]*)/g,"<p>"),i+="</p>",a.push(i))}b=a.length;for(e=0;e<b;e++)for(;a[e].search(/~K(\d+)K/)>=0;)c=d[RegExp.$1],c=c.replace(/\$/g,"$$$$"),a[e]=a[e].replace(/~K\d+K/,c);return a=a.join("\n\n")},n=function(a){a=B(a);a=q(a);a=a.replace(/\\(\\)/g,s);a=a.replace(/\\([`*_{}\[\]()>#+-.!])/g,s);a=a.replace(/(!\[(.*?)\][ ]?(?:\n[ ]*)?\[(.*?)\])()()()()/g,o);a=a.replace(/(!\[(.*?)\]\s?\([ \t]*()<?(\S+?)>?[ \t]*((['"])(.*?)\6[ \t]*)?\))/g,
...
function(a){a=a.replace(/(.)<\/?code>(?=.)/g,"$1`");return a=p(a,"\\`*_")})},f=function(a,d,e,l,i,f,h,g){g==void 0&&(g="");a=l.toLowerCase();if(i=="")if(a==""&&(a=e.toLowerCase().replace(/ ?\n/g," ")),b[a]!=void 0)i=b[a],c[a]!=void 0&&(g=c[a]);else if(d.search(/\(\s*\)$/m)>-1)i="";else return d;i=p(i,"*_");d='<a href="'+i+'"';g!=""&&(g=g.replace(/"/g,"&quot;"),g=p(g,"*_"),d+=' title="'+g+'"');d+=">"+e+"</a>";return d},o=function(a,d,e,l,i,f,g,h){a=e;l=l.toLowerCase();h||(h="");if(i=="")if(l==""&&
(l=a.toLowerCase().replace(/ ?\n/g," ")),b[l]!=void 0)i=b[l],c[l]!=void 0&&(h=c[l]);else return d;a=a.replace(/"/g,"&quot;");i=p(i,"*_");d='<img src="'+i+'" alt="'+a+'"';h=h.replace(/"/g,"&quot;");h=p(h,"*_");d+=' title="'+h+'"';d+=" />";return d},z=function(a){a=a.replace(/^(.+)[ \t]*\n=+[ \t]*\n+/gm,function(a,b){return k("<h1>"+n(b)+"</h1>")});a=a.replace(/^(.+)[ \t]*\n-+[ \t]*\n+/gm,function(a,b){return k("<h2>"+n(b)+"</h2>")});return a=a.replace(/^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm,function(a,
b,c){a=b.length;return k("<h"+a+">"+n(c)+"</h"+a+">")})},r,u=function(a){a+="~0";var b=/^(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm;e?a=a.replace(b,function(a,b,c){a=b;c=c.search(/[*+-]/g)>-1?"ul":"ol";a=a.replace(/\n{2,}/g,"\n\n\n");a=r(a);a=a.replace(/\s+$/,"");return"<"+c+">"+a+"</"+c+">\n"}):(b=/(\n\n|^\n?)(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/g,a=a.replace(b,function(a,b,c,d){a=c;d=d.search(/[*+-]/g)>
...
function onEditChange(){editTimer&&clearTimeout(editTimer);var b=doc.editor.value;b!=lastText&&(client.setDirty(),lastText=b,editTimer=setTimeout(render,EDIT_BUFFER))}function render(){editTimer&&clearTimeout(editTimer);$(doc.output).html("<section class='slides'>"+lastText+"</section>");refresh();tooFarInFuture();onResize()}function tooFarInFuture(){curSlide<slideEls.length||adjustSlidePos(slideEls.length-1)}
...
function onReady(){handleAppCache();doc=dom.bindIDs();client=new clientLib.Client(exports);client.saveInterval=0;client.addAppBar();$(doc.edit).click(toggleEditor);$(doc.insert).click(insertStockCode);$(window).bind("scroll",onScroll);$(doc.editor).keydown(tabToSpace);for(var b=$("script[type=slide-template]"),c,d=0;d<b.length;d++)c=b[d],stockCode[c.title]=$(c).text();$.ajax({url:"slides.html",error:function(){console.log("ajax load error")},success:function(b){lastText=b;doc.editor.value=b;b=document.createElement("script");
b.type="text/javascript";b.src="scripts/slides.js";b.onload=function(){render();handleDomLoaded();$(doc.next).click(nextSlide);$(doc.prev).click(prevSlide)};document.body.appendChild(b)}});$(window).bind("resize",onResize)}function tabToSpace(b){if(b.keyCode==9){var c=this.selectionStart;b.preventDefault();b=$(this).val();b=b.slice(0,c)+"  "+b.slice(c);$(this).val(b);this.selectionEnd=this.selectionStart=c+2}}
function onScroll(){if(editVisible)currentScroll=window.scrollY,setCrossTransform(doc.output,"transform"),setTimeout(positionNav,10)}function positionNav(){if(editVisible){var b=doc.output.offsetHeight*currentScale+window.scrollY;$(doc.nav).css("top",b+"px")}else $(doc.nav).css("top",doc.outputBlock.offsetHeight-35+"px")}
