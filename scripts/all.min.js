...
function setCrossTransform(a,b){var d="translate("+currentShift+"px, 0px) scale("+currentScale+")";$(a).css("-webkit-"+b,d);$(a).css("-moz-"+b,d);$(a).css("-o-"+b,d);$(a).css("-ms-"+b,d);$(a).css(b,d)}function updateMeta(a){document.title=a.title;$("#title").text(a.title);$(doc.fullscreen).unbind();$(doc.fullscreen).attr("href",location.href.replace(/&page=[0-9]+/,"").replace("#doc=","docs/")+"/slides")}
